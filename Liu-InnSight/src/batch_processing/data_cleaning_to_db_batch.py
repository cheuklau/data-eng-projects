...
Note: Loading to Postgres was found to be far less efficient than writing to Parquet.
      Therefore, just use data_cleaning_to_parquet_batch.py
"""
...
for file in file_list:
    try:
        ...
        # Write final dataframe to postgres
        # Note the write.jdbc method of the Spark dataframe object
